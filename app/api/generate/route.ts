...
export async function GET(req: NextRequest) {
  try {
    ...
    const frontPrompt = [
      ...
      "TEXT RULES (STRICT): The ONLY text allowed in the entire image is the provided Japanese message.",
      "Do NOT add any other characters anywhere: no extra Japanese, no English letters, no random glyphs, no numbers (except those already in the message), and no symbols or punctuation beyond what appears in the message.",
